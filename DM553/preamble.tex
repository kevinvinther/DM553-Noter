...
\setmonofont{Inconsolata LGC Nerd Font}                          %  to turn out curly
                                                       %  ("typographic")
...
% Define a new style for theorems, definitions, lemmas, etc.
\newtheoremstyle{customstyle} % Name of the style
{10pt}                        % Space above
{10pt}                        % Space below
{}                    % Body font
{}                            % Indent amount
{\large\bfseries\sffamily\color{SchemeDark}} % Theorem head font
...
% Define theorem, definition, lemma environments
...
% Optionally, create a custom command for proof environment
\renewenvironment{proof}{\vspace{10pt}{\large\noindent\bfseries\sffamily Bevis:\\}}{\qed \vspace{10pt}}
