...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		...
		\node[block, minimum width=1.0cm, minimum height=1.0cm, draw=CoralRed, line width=0.40mm] (reading) at (2.4, 0.0) {};
		\node[draw=none, fill=none, text=CoralRed] at (2.4, -0.7) { Hovedet };
		\node[draw=none, fill=none] at (8.0, 0.0) {$\rightarrow \infty$};
		\node[draw=none, fill=none, text=DeepSeaBlue] at (5.4, -0.7) { State $q_{i}$ };
		...
		\node[block, minimum width=1.0cm, minimum height=1.0cm, draw=CoralRed, line width=0.40mm] (reading) at (1.6, -3.0) {};
		\node[draw=none, fill=none, text=CoralRed] at (1.6, -3.7) { Hovedet };
		\node[draw=none, fill=none] at (8.0, -3.0) {$\rightarrow \infty$};
		\node[draw=none, fill=none, text=DeepSeaBlue] at (5.4, -3.7) { State $q_{j}$ };
	\end{tikzpicture}
...
\begin{figure}[ht]
	\centering
	\begin{tikzpicture}
		\draw[Light,fill=Light,dashed, thick, opacity=0.2] (0.5,0) ellipse (4cm and 2cm);
		\draw node at (1.7,1) {Genkendelige sprog};
		\draw[DeepSeaBlue,fill=DeepSeaBlue,dashed, thick, opacity=0.5] (-1.0,0) ellipse (2cm and 1.0cm);
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		...
		\foreach \label [count=\y] in \indices {
			\node[draw=none, fill=none, minimum width=0.8cm, minimum height=0.8cm,color=CoralRed] (block\y) at (\startx + \gap*\y - \gap,0.7) {\label};
		}
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		...
		\node[block, minimum width=1.0cm, minimum height=1.2cm, draw=CoralRed, line width=0.4mm] (h1) at (1.6, 0.0) {};
		\node[draw=none, fill=none, text=CoralRed] (h1t) at (1.6, -1.0) {$h_{1}$};

		\node[block, minimum width=1.0cm, minimum height=1.2cm, draw=TurquoiseGreen, line width=0.4mm] (h1) at (3.2, 0.0) {};
		\node[draw=none, fill=none, text=TurquoiseGreen] (h1t) at (3.2, -1.0) {$h_{2}$};

		\node[block, minimum width=1.2cm, minimum height=2.0cm, draw=DeepSeaBlue, line width=0.4mm] (h1) at (3.2, -0.2) {};
		\node[draw=none, fill=none, text=DeepSeaBlue] (h1t) at (3.2, -1.5) {$h_{3}$};

		\node[block, minimum width=1.0cm, minimum height=1.2cm, draw=SunsetOrange, line width=0.4mm] (h1) at (4.8, 0.0) {};
		\node[draw=none, fill=none, text=SunsetOrange] (h1t) at (4.8, -1.0) {$h_{4}$};
	\end{tikzpicture}
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		...
		\node[block, minimum width=1.0cm, minimum height=1.2cm, draw=CoralRed, line width=0.4mm] (h1) at (3.2, -3.2) {};
		\node[draw=none, fill=none, text=CoralRed] (h1t) at (3.2, -4.2) {$h_{1}$};
	\end{tikzpicture}
	\caption{\label{fig:flerehoveder} Flerhovedet-bånd variant.}
\end{figure}
...
\end{proof}
	...
	\begin{figure}[ht]
		...
		\begin{tikzpicture}
			...
			\draw[->, color=TurquoiseGreen] (ww.east) -- (6, -2) -- (6, -4) -- (0, -4) -- (E.south);

			\node[fill=none, draw=none, color=TurquoiseGreen] (genstart) at (3, -3.8) {Genstart};
			...
			\draw[color=DeepSeaBlue, thick] (-1, 1) -- (7, 1) -- (7, -5) -- (-1, -5) -- cycle;

			\node[fill=none, draw=none, color=DeepSeaBlue] (me) at (7.5, -5) {$M_{E}$};

			\node[fill=none, draw=none, color=CoralRed] (printed) at (7, 2) {Næste streng printet af $E$};

			\draw[->, color=CoralRed] (printed) -- (wprime);
		\end{tikzpicture}
