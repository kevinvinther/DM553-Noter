...
\declaretheorem[style=thmredbox, name=Proof, numberlike=mycounter]{theorem}
...
\declaretheorem[style=thmredbox, name=Conjecture, numberlike=mycounter]{conjecture}
\declaretheorem[style=thmbluebox, name=Claim, numberlike=mycounter]{claim}
\declaretheorem[style=thmbluebox, name=Example, numberlike=mycounter]{example}
\declaretheorem[style=thmbluebox, name=Exercise, numberlike=mycounter]{exercise}
\declaretheorem[style=thmbluebox, name=Remark, numberlike=mycounter]{remark}
...
% Command to format chapter title in the header (without bold)
\fancyhead[LO]{\textnormal{Chapter \thechapter: \leftmark}}  % Left header on Odd pages
\fancyhead[RE]{\textnormal{Chapter \thechapter: \leftmark}}  % Right header on Even pages

\fancyfoot[C]{\thepage}  % Centered page number in the footer

% Additional setup to extract the chapter name
\renewcommand{\chaptermark}[1]{\markboth{#1}{}}

% Custom headrule that adjusts length dynamically based on the text width
\renewcommand{\headrule}{%
	\ifodd\value{page}
		% For odd pages: left-aligned rule with dynamic width
		\makebox[0pt][l]{\rule[0.5\baselineskip]{\widthof{\textnormal{Chapter \thechapter: \leftmark}}}{\headrulewidth}}%
	\else
		% For even pages: right-aligned rule with dynamic width
		\makebox[\textwidth][r]{\rule[0.5\baselineskip]{\widthof{\textnormal{Chapter \thechapter: \leftmark}}}{\headrulewidth}}%
	\fi
	\vskip-\headrulewidth
}
...
\pagestyle{fancy} % Ensure that the fancy page style is applied to the entire document
